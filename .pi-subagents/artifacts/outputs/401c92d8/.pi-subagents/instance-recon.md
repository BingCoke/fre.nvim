...
```acceptance-report
{"criteriaSatisfied":[{"id":"criterion-1","status":"satisfied","evidence":"Concrete blocker/major findings cite exact files and ranges; minimal removals, red tests, and residual risks are listed."}],"changedFiles":[],"testsAddedOrUpdated":[],"commandsRun":[{"command":"tests","result":"not-run","summary":"Read-only inspection; no tests requested or executed."}],"validationOutput":["Inspected exactly the eight scoped files."],"residualRisks":["Direct external users of fre.inheritance were not searched outside the mandated scope.","Removing expansion inheritance intentionally removes covered async restoration behavior."],"noStagedFiles":true,"diffSummary":"No source or test files changed; only the requested review artifact was written.","reviewFindings":["blocker: lua/fre/manager.lua:109-115 - opts.inherit passes a source instance into construction.","blocker: lua/fre/config.lua:278-291,416-466 - config inherits runtime sort/hidden state.","blocker: lua/fre/instance.lua:1764 - instance stores inheritance-only trie state.","major: lua/fre/instance.lua:296,816,821,844 - lifecycle is coupled to inheritance hooks."],"manualNotes":"Read-only review, compressed to under 80 lines."}
```
