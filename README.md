...
| `FreHiddenFile` | 当前隐藏文件 basename | link 到 `Comment` |
| `FreHiddenDirectory` | 当前隐藏目录 basename | link 到 `Directory` |
...
local function set_fre_highlights()
  ...
  vim.api.nvim_set_hl(0, "FreDirectoryPath", { link = "Directory" })
...
vim.api.nvim_set_hl(0, "FreHiddenDirectory", { fg = "#8fb99f" })
```
