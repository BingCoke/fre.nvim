...
describe("fre ticket 17 actions and mappings", function()
  ...
  it("inserts child-relative and root-relative drafts ready for filename completion", function()
    ...
    local child_keys = vim.api.nvim_replace_termcodes("]nchild.txt<Esc>", true, false, true)
    vim.api.nvim_feedkeys(child_keys, "mx", false)
    ...
    local root_keys = vim.api.nvim_replace_termcodes("]Nroot.txt<Esc>", true, false, true)
    vim.api.nvim_feedkeys(root_keys, "mx", false)
