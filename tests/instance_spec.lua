...
describe("fre async hidden instances", function()
  ...
  it("returns immediately with an independent loading buffer and stable lexical root", function()
    ...
    assert.are.equal("[fre] Loading " .. instance.root, lines(instance.bufnr)[1])
  ...
  it("keeps instances and buffers separate, including current-buffer lookup", function()
    ...
    callbacks[1](nil, {})
    callbacks[2](nil, {})
    wait_for(function() return first.state == "ready-hidden" and second.state == "ready-visible" end)
  ...
  it("delivers when_ready and FreReady exactly once for one attempt", function()
    ...
    pending(nil, {})
    pending(nil, {})
    wait_for(function() return instance.state == "ready-hidden" and #events == 1 and callback_count == 1 end)
  ...
  it("retries a failed initial load and permits explicit cleanup", function()
    ...
    callbacks[2](nil, {})
    wait_for(function()
      return instance.state == "ready-hidden" and failures == 1 and successes == 1
